...
import logoWhite from '../assets/images/newlogo-white.png'
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-between" aria-label="Global">
        <div className="container flex items-center">
          <div className="flex lg:flex-1">
            <Link
              href="/#startseite"
              className="-m-1.5 p-1.5 top-1 relative block"
            >
              <div className="flex flex-col items-center">
                ...
                <span
                  className={
                    'mt-1 block text-[11px] text-center translate-x-[16px] ' +
                    (active ? 'text-gray-600' : 'text-white')
                  }
                >
                  Zertifiziert nach VDI 2052
                </span>
      ...
      <Dialog as="div" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        <Dialog.Panel
          className={
            'fixed inset-0 z-30 overflow-y-auto bg-white px-6 py-6 lg:hidden ' +
            (active ? 'py-4' : '')
          }
        >
          <div className="flex items-center justify-between">
            <a href="/#startseite" className="-m-1.5 p-1.5 text-end top-0.5 relative">
              <Image
                src={logo}
                className="duration-100 object-contain"
                alt="AirClean Setec Logo"
