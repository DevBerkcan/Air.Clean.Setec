  ...
  return (
    <section className="px-6 py-20" id="about">
      <div className="container text-center py-8 lg:py-16">
        ...
        <span className="text-sm font-semibold bg-orange-100 text-orange-400 rounded-full px-3 py-1">Über uns</span>
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl"> AK - So gründlich wie noch nie.</h2>
