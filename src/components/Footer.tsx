      ...
      <div className="container border-t border-gray-200 py-10">
        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-600">
                <li className="mb-4">
                  <a href="https://linkedin.com/aircleanvs" target="_blank" rel="noreferrer" className="hover:underline">Linkedin</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="grid gap-y-2 grid-cols-1 md:grid-cols-3">
          ...
          <div className="flex space-x-6 justify-center md:justify-end">
            <a href="https://linkedin.com/aircleanvs" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 434 415" xmlns="http://www.w3.org/2000/svg">
