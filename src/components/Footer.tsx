      ...
      <div className="container border-t border-gray-200 py-10">
        ...
        <div className="md:flex md:justify-between">
            ...
            <ul className="text-gray-600">
              <li className="mb-4">
                <Link href="/#startseite" className="flex items-center">
                  <Image src={logo} className="w-[160px] mr-3" alt="AirClean Setec Logo" />
                </Link>
              </li>
              ...
              <li>
                <a href="tel:+4915122851195" className="hover:underline">+49 1512 2851195</a>
              </li>
              <li>
                <a href="mailto:info@airclean-setec.de" className="hover:underline">info@airclean-setec.de</a>
              </li>
            </ul>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-600">
                <li className="mb-4">
                  <a href="https://linkedin.com/company/airclean-setec" target="_blank" rel="noreferrer" className="hover:underline">LinkedIn</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="grid gap-y-2 grid-cols-1 md:grid-cols-2">
          <span className="text-sm text-gray-500 text-center md:text-start">
            © 2024 <Link href="/" className="hover:underline">AirClean Setec™</Link>. All Rights Reserved.
          </span>
          <div className="flex space-x-6 justify-center md:justify-end">
            <a href="https://linkedin.com/company/airclean-setec" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900" aria-label="AirClean Setec auf LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 434 415" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
